...
class UpdateProcessor {
     ...
     *
     * @var \App\Plugin\Service\Type\Analyse\Drupal\UpdateFetcher
     */
     ...
     *
     * @param \App\Plugin\Service\Type\Analyse\Drupal\UpdateFetcher $update_fetcher
     *   The update fetcher service.
     */
    public function __construct(
        UpdateFetcher $update_fetcher,
    ) {
        $this->updateFetcher = $update_fetcher;
    }

    public function setCompat(string $compat) {
        $this->updateFetcher->setCompat($compat);
    }

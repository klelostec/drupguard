...
final class ExtensionVersion {
     ...
     * @var string
     */
    const CORE_PREFIX_D8 = '8.x-';
    const CORE_PREFIX_D7 = '7.x-';
    ...
    public static function createFromVersionString(string $version_string): ExtensionVersion {
        ...
        if (str_starts_with($version_string, static::CORE_PREFIX_D8) && $version_string !== '8.x-dev') {
            $version_string = preg_replace('/8\.x-/', '', $version_string, 1);
        }
        elseif (str_starts_with($version_string, static::CORE_PREFIX_D7) && $version_string !== '7.x-dev') {

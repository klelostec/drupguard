 ...
 */
final class Version20230915094421 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_2FB3D0EEF78A6C55 ON project');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_2FB3D0EEF78A6C55 ON project (last_analyse_id)');
    }
}
